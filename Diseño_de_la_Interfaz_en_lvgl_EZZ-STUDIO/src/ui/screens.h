...
typedef struct _objects_t {
    ...
    lv_obj_t *ns_delta;
    lv_obj_t *obj3;
    lv_obj_t *btn_view_config_1;
    lv_obj_t *ns_data;
    lv_obj_t *icon_alarm_on;
    lv_obj_t *grap_texto;
    lv_obj_t *ns_grap_alert_min;
    lv_obj_t *label_y;
    lv_obj_t *grap_cont;
    lv_obj_t *grap_line;
    lv_obj_t *grap_alert;
    ...
    lv_obj_t *ns_grap_alert_max;
    lv_obj_t *obj4;
    lv_obj_t *obj5;
    lv_obj_t *obj6;
    lv_obj_t *alarm_swich;
    lv_obj_t *label_estado;
    lv_obj_t *btn_alarm_ok;
    lv_obj_t *txt_alarm_hh;
    lv_obj_t *txt_alarm_mm;
    lv_obj_t *txt_alarm_repit;
    lv_obj_t *obj7;
    lv_obj_t *alarm_is_mon;
    lv_obj_t *obj8;
    lv_obj_t *alarm_is_tues;
    lv_obj_t *alarm_is_wed;
    lv_obj_t *alarm_is_thu;
    lv_obj_t *alarm_is_fri;
    lv_obj_t *alarm_is_sat;
    lv_obj_t *alarm_is_sun;
    lv_obj_t *obj9;
    lv_obj_t *obj10;
    lv_obj_t *obj11;
    lv_obj_t *obj12;
    ...
    lv_obj_t *ns_alert_after_min;
    lv_obj_t *ns_repeat_through;
    lv_obj_t *teclado;
} objects_t;
